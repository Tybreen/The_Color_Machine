...
function setup() {
    ...
    ProjectileColor_Sprite.onMouseReleased = function() { ProjectileColor = PromptsForButtons("Projectile Color OR Random:  NO Spaces", ProjectileColor) };
    ...
    RateOfFire_Sprite.onMouseReleased = function() {
        RateOfFire = PromptsForButtons("Rate of Fire   Max = 32", RateOfFire);
        if(RateOfFire > 32) RateOfFire = 32;
    }
