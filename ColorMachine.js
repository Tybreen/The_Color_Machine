...
function setup() {
    ...
    BackgroundColor_Sprite = createSprite(60, 50, 80, 30);
    ...
    Preset1_Sprite = createSprite(60, 100, 80, 30);
    ...
    Preset2_Sprite = createSprite(60, 150, 80, 30);
    ...
    Preset3_Sprite = createSprite(60, 200, 80, 30);
    ...
    RateOfFire_Sprite.onMouseReleased = function() { RateOfFire = PromptsForButtons("Rate of Fire", RateOfFire) };
...
function keyPressed() {
    ...
    if(keyCode == 32 && !ButtonsShowing) {
        ButtonsShowing = true;
    }

    else if(keyCode == 32 && ButtonsShowing) {
...
function draw() {
    ...
    if(InstructionText && ButtonsShowing) {
    ...
    if(ButtonsShowing) {
        ...
        text("Background Color", 60, 34);

        textSize(15);

        text("Preset 1", 60, 84);
        text("Preset 2", 60, 134);
        text("Preset 3", 60, 184);

        text("Click", 60, 105);
        text("Click", 60, 155);
        text("Click", 60, 205);

        text("Press the", 60, 235);

        text("Space Bar!", 60, 255);
